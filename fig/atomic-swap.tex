  ...
  \begin{umlseqdiag}
    ...
    \begin{umlfragment}[type={\shortstack[l]{1. Funding}},name=funding,label=Init]
        \begin{umlcall}[op={generate a secret and hash},draw=OliveGreen,fill=OliveGreen!20]{Alice}{Alice}
          \begin{umlcall}[op={Fund HTLC},draw=BrickRed, fill=OliveGreen!20,  return=FundingTx]{Alice}{Bitcoin Blockchain}
          \end{umlcall}
          \begin{umlcall}[op={Transfer the hash},draw=OliveGreen,fill=OliveGreen!20]{Alice}{Bob}
            \begin{umlcall}[op={Watch the transaction and verify},draw=OliveGreen,fill=OliveGreen!20,dt=4]{Bob}{Bitcoin Blockchain}
             \end{umlcall}
             \end{umlcall}
             \begin{umlcall}[op={Fund HTLC},draw=BrickRed,fill=OliveGreen!20, return=fundingTx]{Bob}{Ethereum Blockchain}
    ...
    \begin{umlfragment}[type={\shortstack[l]{3. Refunding}},name=refunding,label=Fail]
      \begin{umlcall}[dt=20, op={Timelock reached},draw=MidnightBlue,fill=MidnightBlue!20]{Ethereum Blockchain}{Ethereum Blockchain}
       ...
       \begin{umlcall}[dt=6, op={Get refunding transaction},draw=BrickRed,fill=BrickRed!20]{Ethereum Blockchain}{Bob}
     \end{umlcall}
     \end{umlcall}
     \end{umlcall}
       \begin{umlcall}[dt=30, op={Timelock reached},draw=MidnightBlue,fill=MidnightBlue!20]{Bitcoin Blockchain}{Bitcoin Blockchain}
         ...
         \begin{umlcall}[dt=6, op={Get refunding transaction},draw=BrickRed,fill=BrickRed]{Bitcoin Blockchain}{Alice}
     \end{umlcall}
     \end{umlcall}
     \end{umlcall}
    \end{umlfragment}
