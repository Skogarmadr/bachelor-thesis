...
\begin{tikzpicture}[thick]                    
  \begin{umlseqdiag}
    ...
    \umlsdnode[dt=8]{Bob}
    \umlnote[x=0,y=-20.5,width=6cm,fill=solarizedbeige]{refunding}{If Alice don't follow, the timelock of bob will be reached. Bob will get his fund back. After that Alice wait for her timelock and will get her fund back.}
  \end{umlseqdiag}
